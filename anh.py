...
contours = get_contours(image, min_area=50000, draw_cont=False, show_canny=False)
biggest_rect = contours[0][1]
warp_img = warp_image(image, biggest_rect, width=scale * w_a4, height=scale * h_a4)
...
display_test = cv2.resize(image, None, fx=0.35, fy=0.35, interpolation=cv2.INTER_AREA)
